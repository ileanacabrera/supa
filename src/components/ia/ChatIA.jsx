...
const ChatIA = ({ mostrar, onCerrar }) => {
  ...
  - productos (id_productos, nombre, precio, descripcion, url_imagen)
  - ventas (id_venta, id_clientes, id_empleado, fecha_venta, metodo_pago, total)
  - detalles_ventas (id_detalle, id_venta, id_productos, cantidad, precio_unitario, subtotal)
